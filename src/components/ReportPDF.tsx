  ...
  return (
    <div className="space-y-6 select-none max-w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl shadow-sm print:hidden">
        <div className="flex items-center gap-3">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400">
            Previewing: <strong className="text-slate-800 dark:text-white">{report.reportNumber}</strong>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start relative max-w-full">
        ...
        {isSettingsOpen && (
          <div className="w-full lg:w-80 shrink-0 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm space-y-6 print:hidden">
            <div>
        ...
        {/* Scrollable Document Stage Wrapper */}
        <div className="flex-grow flex justify-center py-2 w-full overflow-x-auto select-text">
          <div 
            ...
            className="w-[210mm] min-h-[296mm] bg-white text-slate-900 border border-slate-300 shadow-xl relative overflow-hidden print:border-0 print:shadow-none print:p-0 print:m-0"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-8 border-t border-slate-200 items-end mt-auto">
