...
-- Note: Ensure Row Level Security (RLS) is disabled or proper security policies are set to allow anonymous upserts/inserts if using public API Key bypasses.
`;
